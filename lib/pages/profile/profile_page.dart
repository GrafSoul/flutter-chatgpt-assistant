    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return Column(
          children: [
            Obx(() {
              if (profileController.userData.isNotEmpty) {
                return Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Имя: ${profileController.userData['name']}"),
                      Text("Email: ${profileController.userData['email']}"),
                      Text("Роль: ${profileController.userData['role']}"),
                    ],
                  ),
                );
              } else {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      if (profileController.newPasswordController.text ==
                        ...
                        controller.updateUserPassword(profileController.currentPasswordController.text,
